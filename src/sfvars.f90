MODULE SFVARS
  ...
  TYPE PARAMS
     REAL(DP) :: age=13.5,feh=0.0,afe=0.0,nhe=0.0,cfe=0.0,nfe=0.0,nafe=0.0,&
          ...
          bafe=0.0,eufe=0.0,teff=0.0,imf1=1.3,imf2=2.3,logfy=1E-5,sigma=0.0,&
          sigma2=0.0,velz=0.0,velz2=0.0,logm7g=1E-5,hotteff=20.0,loghot=1E-5
     REAL(DP), DIMENSION(neml) :: logemnorm=0.0
