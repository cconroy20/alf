SUBROUTINE SET_PINIT_PRIORS(pos,prlo,prhi,velz)
  ...
  pos%velz3          = (myran()-0.5)*500
  pos%logfrac_velz3  = myran()*2-4
  ...
  IF (prlo%velz3.EQ.test%velz3) prlo%velz3    = -1e3
  IF (prlo%logfrac_velz3.EQ.test%logfrac_velz3) prlo%logfrac_velz3 = -6.0
  ...
  IF (prhi%velz3.EQ.test%velz3) prhi%velz3    = 1e3
  IF (prhi%logfrac_velz3.EQ.test%logfrac_velz3) prhi%logfrac_velz3 = -0.4
